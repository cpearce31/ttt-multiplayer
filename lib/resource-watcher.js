...
/*
  This code is copied directly from the `game-project-api` repo, as the
  multiplayer documentation there suggests. I just ran `make-standard` on it.
  It's a wrapper around `EventSource`, which is a native streaming event
  subscribption module.
*/
